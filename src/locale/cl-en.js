...
(function (global) {
  ...
  const keys = {
    ...
    '230': 'Oops! We cannot find this call. Working on it right now.',
    ACTION: {
      REPLY: 'Replied',
      COMMENT: 'Commented',
    ...
    ACTION_BODY: {
      ACCEPTED: 'Your idea has been accepted. We will start working on it soon.',
      COMPLETED: 'Your idea has been marked as complete.'
    },
